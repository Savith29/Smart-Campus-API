 ...
 * No class-level @Path — context provided by SensorResource locator.
 */
...
public class SensorReadingResource {
    ...
    public Response addReading(String requestBody) {
        ...
        // Part 5.3 — Block if sensor is in MAINTENANCE → 403
    ...
    public Response getReadingById(@PathParam("readingId") String readingId) {
        ...
        if (!found.isPresent())
            return error(404, "Reading '" + readingId + "' not found for sensor '" + sensorId + "'.");
