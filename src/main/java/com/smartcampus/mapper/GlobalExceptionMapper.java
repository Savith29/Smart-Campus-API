 ...
 * Catches ALL unhandled Throwables and returns HTTP 500.
 * Full stack trace logged server-side ONLY — never exposed to clients.
 */
@Provider
public class GlobalExceptionMapper implements ExceptionMapper<Throwable> {
    ...
    public Response toResponse(Throwable ex) {
        LOG.log(Level.SEVERE, "Unexpected internal error: " + ex.getMessage(), ex);
